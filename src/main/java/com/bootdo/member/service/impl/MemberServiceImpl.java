...
public class MemberServiceImpl implements MemberService {
	...
	@Override
	public MemberDO get(Integer tmId){
		return memberDao.get(tmId);
	}
	...
	@Override
	public int remove(Integer tmId){
		return memberDao.remove(tmId);
	}
	
	@Override
	public int batchRemove(Integer[] tmIds){
		return memberDao.batchRemove(tmIds);
	}
